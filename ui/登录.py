...
class LoginWindow(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.label_account.setGeometry(320, 150, 300, 45)
        self.input_account = QtWidgets.QLineEdit(self)
        self.input_account.setGeometry(380, 150, 300, 30)

        # 密码输入框
        self.label_password = QtWidgets.QLabel("密码：", self)
        self.label_password.setGeometry(320, 210, 100, 45)
        self.input_password = QtWidgets.QLineEdit(self)
        self.input_password.setGeometry(380, 210, 300, 30)
        self.input_password.setEchoMode(QtWidgets.QLineEdit.Password)

        # 登录按钮
        self.button_login = QtWidgets.QPushButton("登录", self)
        self.button_login.setGeometry(400, 300, 80, 30)

        # 注册按钮
        self.button_register = QtWidgets.QPushButton("注册新用户", self)
        self.button_register.setGeometry(520, 300, 120, 30)
    ...
    def login_action(self):
        ...
        if login(account, password):
            ...
            self.close()
            self.main_window1.resize(1000, 800)
