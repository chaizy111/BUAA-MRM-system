...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(1, _translate("MainWindow", "微信"))
        self.comboBox.setItemText(2, _translate("MainWindow", "支付宝"))
        self.comboBox.setItemText(3, _translate("MainWindow", "现金"))
